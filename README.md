...
To install ckanext-virginia_schema:
...
3. Add `virginia_schema` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.virginia_schema.some_setting = some_default_value
...
## Releasing a new version of ckanext-virginia_schema

If ckanext-virginia_schema should be available on PyPI you can follow these steps to publish a new version:
